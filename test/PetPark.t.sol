...
contract PetParkTest is Test, PetPark {
    ...
    function testCannotAddAnimalWhenNonOwner() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(OnlyOwner.selector, address(this), notOwner));
        vm.prank(notOwner);
        petPark.add(AnimalType.Fish, 5);
    }
    ...
    function testCannotBorrowWhenAgeZero() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(CannotBorrowWhenAgeZero.selector));
